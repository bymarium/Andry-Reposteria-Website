      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
				<div class="row">
                    ...
                    <div class="col-xs-4">
						<div class="input-group">
						  <input type="text" class="form-control" placeholder="Buscar por nombre del proveedor " id='q' onkeyup="load(1);">
					...
					<div class="col-xs-3 ">
						<div class="btn-group pull-right">
							<?php if ($permisos_ver==1){?>
							<a href="new_purchase_order.php" class="btn btn-default"><i class='fa fa-plus'></i> Nueva orden</a>
							<?php }?>
